	...
	var e = $(i), g = "waypoint.reached", b = function(o, n) {
						...
						this,
						{
							...
							doScroll : $
									.proxy(
											function() {
												var q = this.element
														.scrollTop(), p = q > this.oldScroll, s = this, r = $
														.grep(
																this.waypoints,
																function(u, t) {
																	return p ? (u.offset > s.oldScroll && u.offset <= q)
		...
		init : function(o, n) {
			this.each(function() {
				...
				var p = h(t, q), s = p < 0 ? $.fn[k].defaults
						: q.waypoints[p].options, r = $.extend({}, s, n);
				r.offset = r.offset === "bottom-in-view" ? function() {
					var v = $.isWindow(u) ? $[m]("viewportHeight") : $(u)
							.height();
		...
		refresh : function() {
			$.each(f,
					function(r, s) {
						var q = $.isWindow(s.element[0]), n = q ? 0 : s.element
								.offset().top, p = q ? $[m]("viewportHeight")
								: s.element.height(), o = q ? 0 : s.element
								.scrollTop();
						$.each(s.waypoints, function(u, x) {
							...
							if (typeof x.options.offset === "function") {
								...
								if (typeof x.options.offset === "string") {
									...
									t = x.options.offset.indexOf("%") ? Math
											.ceil(p * (v / 100)) : v
								}
							}
