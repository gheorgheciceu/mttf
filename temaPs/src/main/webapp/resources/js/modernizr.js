...
window.Modernizr = (function( window, document, undefined ) {
    ...
    injectElementWithStyles = function( rule, callback, nodes, testnames ) {
      ...
      var style, ret, node, docOverflow,
          ...
          // After page load injecting a fake body doesn't work so check if
			// body exists
          body = document.body,
      ...
      if ( !body ) {
          ...
          // Safari 5.13/5.1.4 OSX stops loading if ::-webkit-scrollbar is
			// used and scrollbars are visible
    ...
    /**
	 * testDOMProps is a generic DOM property test; if a browser supports a
	 * certain property, it won't return undefined for it.
	 */
    ...
    /* >>testallprops */
    /**
	 * testPropsAll tests a list of DOM properties we want to check against. We
	 * specify literally ALL possible (known and/or likely) properties on the
	 * element including the non-vendor prefixed one, for forward-
	 * compatibility.
	 */
	 ...
	 * events, which does not necessarily reflect a touchscreen device, as
	 * evidenced by tablets running Windows 7 or, alas, the Palm Pre / WebOS
	 * (touch) phones.
	 * 
	 * Additionally, Chrome (desktop) used to lie about its support on this, but
	 * that has since been rectified: crbug.com/36415
	 * 
    ...
    // The old API is still available in 1.6, but as of 2.0 will throw a
	// warning,
    ...
    tests['multiplebgs'] = function() {
        // Setting multiple images AND a color on the background shorthand
		// property
        // and then querying the style.background property value for the number
		// of
